...
#define PLUG_HEIGHT 534
#define PLUG_FPS 60
#define PLUG_SHARED_RESOURCES 0
#define PLUG_HOST_RESIZE 0

#define AUV2_ENTRY ComPressure_Entry
#define AUV2_ENTRY_STR "ComPressure_Entry"
#define AUV2_FACTORY ComPressure_Factory
#define AUV2_VIEW_CLASS ComPressure_View
#define AUV2_VIEW_CLASS_STR "ComPressure_View"
