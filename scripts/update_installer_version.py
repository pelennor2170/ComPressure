...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ComPressure Demo Installer\n"
      else:
        line="OutputBaseFilename=ComPressure Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ComPressure Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ComPressure installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ComPressure Demo installer\n"
     else:
       line="SetupWindowTitle=ComPressure installer\n"
